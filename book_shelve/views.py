...
from .forms import EBooksForm
from .models import Shelves_books
...
def explore(request):
	edu_books = Shelves_books.objects.filter(category='Education')
	fiction_books = Shelves_books.objects.filter(category='Fiction')
	science_books = Shelves_books.objects.filter(category='Science')
...
def contri(request,user_id):
	books = Shelves_books.objects.filter(author_id=user_id)
...
def deleteBook(request,book_id):
	book = Shelves_books.objects.get(id=book_id)
	book.delete()
	return redirect('home')
